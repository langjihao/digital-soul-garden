...
const dict = {
  zh: {
    ...
    auth: {
      ...
      signUp: "注册",
      signedInAs: "已登录",
      anonHint: "未登录，将以匿名身份发表",
      namePlaceholder: "昵称 *",
      emailPlaceholder: "邮箱（可选，不会公开）",
    },
    comments: {
      title: "评论",
      count: (n: number) => `${n} 条`,
  ...
  en: {
    ...
    auth: {
      ...
      anonHint: "Not signed in — your comment will appear as anonymous",
      namePlaceholder: "Name *",
      emailPlaceholder: "Email (optional, never shown)",
    },
    comments: {
      title: "Comments",
      count: (n: number) => `${n}`,
      ...
      posting: "Posting…",
      failed: "Failed to post, try again.",
      loading: "Loading…",
    },
    annotations: {
      annotate: "Annotate",
      title: "Margin discussion",
